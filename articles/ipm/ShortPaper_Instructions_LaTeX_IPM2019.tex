...
\usepackage[cp1250]{inputenc} % Windows code page (cp1250), for Unicode type use 'utf8' (if necessary)
...
\address{$^1$Institution of first author \\
Address\\
e-mail: first@e-mail.address \and
$^2$
Institution of second (and third) author \\
Address\\
e-mail: \{second, third\}@ e-mail.address}
